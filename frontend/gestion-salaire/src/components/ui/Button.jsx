...
const Button = forwardRef(({ 
  ...
  const variantClasses = {
    ...
    outline: 'border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-blue-500 disabled:bg-white disabled:text-gray-300',
  };
  ...
  // Ajouter type et onClick seulement pour les buttons
  if (Component === 'button') {
